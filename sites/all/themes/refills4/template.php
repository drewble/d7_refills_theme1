...
function refills4_breadcrumb($vars) {
...
/*
function refills4_preprocess_html(&$vars) {
  //  kpr($vars['content']);
}
*/

function refills4_preprocess_page(&$vars,$hook) {
...
/*
function refills4_preprocess_region(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function refills4_preprocess_block(&$vars, $hook) {
  //  kpr($vars['content']);
...
*/
/*
function refills4_preprocess_node(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function refills4_preprocess_comment(&$vars,$hook) {
  //  kpr($vars['content']);
}
*/
/*
function refills4_preprocess_field(&$vars,$hook) {
  //  kpr($vars['content']);
...
*/
/*
function refills4_preprocess_maintenance_page(){
  //  kpr($vars['content']);
}
*/

function refills4_form_search_block_form_alter(&$form, &$form_state, $form_id) {
